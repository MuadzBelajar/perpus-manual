...
<!-- Tombol tambah (+) diletakkan di samping judul menggunakan Flexbox agar rapi -->
<h1 style="display: flex; align-items: center; gap: 12px;">
    Perpustakaan
    <a href="tambah.php" style="text-decoration: none; background-color: #007bff; color: white; padding: 2px 14px; border-radius: 6px; font-size: 24px; line-height: 1.4; font-weight: bold;">+</a>
</h1>
